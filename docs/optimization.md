...
- **개선 내역**:
  ...
  - **`[ 📷 3x2 피드 갤러리 ]`** / **`[ 🌐 인스타그램 공식 실시간 화면 ]`** 원클릭 스위처 버튼을 신설하여, 필요 시 Meta 인스타그램 공식 프로필 라이브 화면(`https://www.instagram.com/geummakchang/embed`)을 홈페이지에서 직접 1초 만에 감상할 수 있도록 선택권 제공.
